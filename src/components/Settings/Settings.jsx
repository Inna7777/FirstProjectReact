...
let words = ["red", "green", "blue", "yellow", "black", "whate"];
const wordsArr = [{ words: "apple" }, { words: "banana" }, { words: "orange" }];
...
const Settings = () => {
  ...
  return (
    <div className={style.setting}>
      <img
        src="https://www.comsigntrust.com/wp-content/uploads/2014/06/settingsP.png"
        alt=""
      />
      {showPicture}
